...
export default function ImprovedMoreMenu({
  ...
  const [activeSection, setActiveSection] = useState<"profile" | "leaderboard">(
    "profile",
  );

  const getMedalColor = (rank: number) => {
    if (rank === 1)
      return { bg: "from-yellow-400 to-yellow-600", icon: "#FFD700" };
    if (rank === 2) return { bg: "from-gray-300 to-gray-500", icon: "#C0C0C0" };
    if (rank === 3)
      return { bg: "from-orange-400 to-orange-600", icon: "#CD7F32" };
    return { bg: "from-blue-400 to-blue-600", icon: "#3B82F6" };
  };
  ...
  return (
    ...
    >
      <motion.div
        className="bg-linear-to-br from-white to-gray-50 rounded-t-3xl w-full max-h-[90vh] overflow-auto pb-24 shadow-2xl"
        initial={{ y: "100%" }}
        animate={{ y: 0 }}
        exit={{ y: "100%" }}
        ...
        <div className="sticky top-0 bg-white/95 backdrop-blur-xl border-b-2 border-gray-200 z-10 pt-6">
          <div className="flex px-6">
            <button
              ...
              className={`flex-1 py-4 px-6 font-bold transition-all relative ${
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      ...
                      >
                        ...
                        <p className="text-xs opacity-80 mb-1">Нийт оноо</p>
                        <p className="text-2xl font-bold">
                      ...
                      >
                        ...
                        <p className="text-xs opacity-80 mb-1">Дараалал</p>
                        <p className="text-2xl font-bold">
                          {userProfile.streak}
                        </p>
                        <p className="text-xs opacity-70">өдөр</p>
                      </motion.div>
                      ...
                      >
                        ...
                        <p className="text-xs opacity-80 mb-1">Медаль</p>
                        <p className="text-2xl font-bold">
                  ...
                  {[1, 0, 2].map((index) => {
                    ...
                    return (
                      ...
                      >
                        {/* Avatar */}
                        <motion.div
                          className={`relative mb-3 ${index === 1 ? "w-24 h-24" : "w-20 h-20"}`}
                          whileHover={{ scale: 1.1 }}
                        >
                          <div
                            className={`w-full h-full rounded-full bg-linear-to-br ${colors.bg} flex items-center justify-center shadow-2xl border-4 border-white`}
                          >
                            <span
                              className={`${index === 1 ? "text-4xl" : "text-3xl"}`}
                            >
                              {entry.avatar}
                            </span>
                          </div>
                        ...
                        {/* Podium */}
                        <motion.div
                          className={`bg-linear-to-br ${colors.bg} rounded-t-2xl px-6 pt-4 pb-2 text-white text-center shadow-xl min-w-25`}
                          style={{
                            height:
                              index === 1
                                ? "120px"
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <p
                            className={`font-bold ${entry.isCurrentUser ? "text-indigo-700" : "text-gray-800"}`}
                            style={{
                              fontFamily: "Noto Sans Mongolian, Nunito",
                            }}
                          >
